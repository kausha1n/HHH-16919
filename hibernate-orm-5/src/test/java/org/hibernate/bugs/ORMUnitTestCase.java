...
public class ORMUnitTestCase extends BaseCoreFunctionalTestCase {
    ...
    public void initData() {
        ...
        PropertyHolder iph = new PropertyHolder(1L, "I", new IntegerProperty(1L, "acc_num", 1234));
        PropertyHolder sph = new PropertyHolder(2L, "S", new StringProperty(2L, "acc_name", "daily"));
        s.persist(iph);
        s.persist(sph);
        tx.commit();
        s.close();
...
//				"Bar.hbm.xml"
    ...
    public void HHH16919() throws Exception {
        ...
        PropertyHolder ip = session.get(PropertyHolder.class, 1L);
        PropertyHolder sp = session.get(PropertyHolder.class, 2L);
